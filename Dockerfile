...
ADD . .
RUN CGO_ENABLED=0 GO111MODULE=off go build && rice -v -i github.com/TykTechnologies/gromit/configs -i github.com/TykTechnologies/gromit/terraform append --exec gromit
