	...
	cases := []APITestCase{
		{
			...
			ResponseJSON: `[{"cache":"redis0", "config":"conf0", "db":"db0", "apimarkers":"am0", "uimarkers":"um0", "gwdash":""}]`,
...
[{"cache":"redis-br1","db":"db-br1","config":"conf-br1","apimarkers":"br1-am1","uimarkers":"br1-um1", "gwdash":"brach1"},{"cache":"redis1","db":"db1","config":"conf1","apimarkers":"am1","uimarkers":"um1", "gwdash":"branch1"},{"cache":"redis0","db":"db0","config":"conf0","apimarkers":"am0","uimarkers":"um0", "gwdash":"branch0"}]
EOF
pump<<EOF
["pump-br1","master"]
EOF
